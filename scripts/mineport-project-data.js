function createProjectDetail(title, location, typology, category, year, description, image, images, galleryImages) {
    return {
        title: title,
        location: location,
        typology: typology,
...
window.MINEPORT_PROJECT_DETAIL_DATA = [
    ...
    createProjectDetail("Stone Horizon House", "Los Angeles, USA", "Residential", "Architecture", "2024 Winter", ["A study in structural calm and horizontal emphasis, using massing to build quiet tension against the landscape.", "Its design language moves between solidity and openness without becoming heavy."], "../assets/images/projects/project7/card/project7.jpg", null, Array.from({ length: 20 }, function (_, imageIndex) {
        return "../assets/images/projects/project7/gallery/" + (imageIndex + 1) + ".jpg?v=2";
    })),
